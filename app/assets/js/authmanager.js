...
async function fullMicrosoftAuthFlow(entryCode, authMode) {
    try {
        ...
        if(mcTokenResponse.responseStatus === RestResponseStatus.ERROR) {
            if(mcTokenResponse.microsoftErrorCode === MicrosoftErrorCode.UNKNOWN) {
                return Promise.reject({
                    title: Lang.queryJS('auth.microsoft.error.appApprovalTitle'),
                    desc: Lang.queryJS('auth.microsoft.error.appApprovalDesc')
                })
            }
